...
from src.features.verb_set.lemma.matcher import create_verb_lemma_matcher


class TestVerbLemmasMatcher(unittest.TestCase):
    def test_is_matcher_creator_defined(self):
        self.assertTrue(create_verb_lemma_matcher)

    def test_is_matcher_constructed(self):
        self.assertIsInstance(create_verb_lemma_matcher(), PatternSetMatcher)

    def test_constructs_new_instances(self):
        matcher1 = create_verb_lemma_matcher()
        matcher2 = create_verb_lemma_matcher()
