...
from src.features.verb_set.pattern_set import create_verb_tense_pattern_set
...
class TestVerbFeatureSetPatternSet(unittest.TestCase):
    ...
    def setUp(self):
        self.pattern_set = create_verb_tense_pattern_set()

    def test_is_defined(self):
        self.assertTrue(create_verb_tense_pattern_set)
